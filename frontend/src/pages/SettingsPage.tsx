...
// BUG-V5 FIX: version from env var -- not hardcoded '3.0.0'
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="rounded-xl border border-gray-800 bg-gray-900 p-5">
        ...
        <div className="space-y-2 text-xs">
          {[
            {k:"API URL", v:import.meta.env.VITE_API_URL??"http://localhost:8000"},
            {k:"WS URL",  v:import.meta.env.VITE_WS_URL??"ws://localhost:8000"},
            {k:"نسخه",     v:APP_VERSION}
