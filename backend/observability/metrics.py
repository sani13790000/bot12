...
class MetricsRegistry:
    ...
    async def health(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'trades_submitted': self._counters.get('trades_submitted', 0),
            'trades_filled': self._counters.get('trades_filled', 0),
            'trades_rejected': self._counters.get('trades_rejected', 0),
            'order_retries': self._counters.get('order_retries', 0),
