...
def register_settings_handlers(dp: Dispatcher):
                ...
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text="🔔 اعلان سیگنال", callback_data="toggle_signal_notif"
                        ),
                        types.InlineKeyboardButton(
                            text="📈 اعلان معاملات", callback_data="toggle_trade_notif"
                        ),
                    ],
                    [
                        types.InlineKeyboardButton(
                            text="📰 اعلان اخبار", callback_data="toggle_news_notif"
                        ),
                        types.InlineKeyboardButton(
                            text="📋 گزارش روزانه", callback_data="toggle_report_notif"
                        ),
                    ],
                    [types.InlineKeyboardButton(text="🔙 بازگشت", callback_data="back_settings")],
                ]
            ),
            parse_mode="HTML",
        )
    ...
    async def set_timeframe(callback: types.CallbackQuery):
        ...
        await callback.message.edit_text(
            f"✅ <b>تایم‌فریم پیش‌فرض</b>\n\nتایم‌فریم جدید: <b>{tf}</b>", parse_mode="HTML"
        )
