...
from ..auth import require_permission, require_role, Permission, UserRole
...
def register_trade_handlers(dp: Dispatcher) -> None:
    ...
    async def menu_trades(message: types.Message) -> None:
        ...
        if not user:
            await message.answer("\u26a0\ufe0f \u0628\u0631\u0627\u06cc \u062f\u0633\u062a\u0631\u0633\u06cc \u0628\u0647 \u0645\u0639\u0627\u0645\u0644\u0627\u062a \u0628\u0627\u06cc\u062f \u062b\u0628\u062a\u200c\u0646\u0627\u0645 \u06a9\u0646\u06cc\u062f.", parse_mode="HTML")
            return
        ...
        if role and role.value in ("trader", "admin", "super_admin"):
            await message.answer(
                ...
                reply_markup=get_trades_keyboard(full=True), parse_mode="HTML",
            )
        else:
            await message.answer(
                "\U0001f4ca <b>\u0645\u0639\u0627\u0645\u0644\u0627\u062a</b>\n\n\u06af\u0632\u06cc\u0646\u0647 \u0645\u0648\u0631\u062f \u0646\u0638\u0631 \u0631\u0627 \u0627\u0646\u062a\u062e\u0627\u0628 \u06a9\u0646\u06cc\u062f:",
                reply_markup=get_trades_keyboard(full=False), parse_mode="HTML",
            )

    @dp.message(F.text == "\U0001f4cb \u0645\u0639\u0627\u0645\u0644\u0627\u062a \u0628\u0627\u0632")
    async def show_open_trades(message: types.Message) -> None:
        token = await rbac_service.get_user_token(message.from_user.id)
        if not token:
            await message.answer("\u26d4\ufe0f \u0644\u0637\u0641\u0627\u064b \u0627\u0628\u062a\u062f\u0627 \u0648\u0627\u0631\u062f \u0634\u0648\u06cc\u062f.")
            return
        data = await _api_get("/trades/open", token)
        if data is None:
            await message.answer("\u274c \u062e\u0637\u0627 \u062f\u0631 \u062f\u0631\u06cc\u0627\u0641\u062a \u0645\u0639\u0627\u0645\u0644\u0627\u062a. \u0644\u0637\u0641\u0627\u064b \u062f\u0648\u0628\u0627\u0631\u0647 \u062a\u0644\u0627\u0634 \u06a9\u0646\u06cc\u062f.", parse_mode="HTML")
            return
        trades = data.get("trades", [])
        if not trades:
            await message.answer("\U0001f4ed \u0647\u06cc\u0686 \u0645\u0639\u0627\u0645\u0644\u0647 \u0628\u0627\u0632\u06cc \u0648\u062c\u0648\u062f \u0646\u062f\u0627\u0631\u062f.", parse_mode="HTML")
            return
        await message.answer(format_trade_list(trades), parse_mode="HTML")

    @dp.message(F.text == "\U0001f4dc \u062a\u0627\u0631\u06cc\u062e\u0686\u0647 \u0645\u0639\u0627\u0645\u0644\u0627\u062a")
    async def show_trade_history(message: types.Message) -> None:
        ...
        if data is None:
            await message.answer("\u274c \u062e\u0637\u0627 \u062f\u0631 \u062f\u0631\u06cc\u0627\u0641\u062a \u062a\u0627\u0631\u06cc\u062e\u0686\u0647. \u0644\u0637\u0641\u0627\u064b \u062f\u0648\u0628\u0627\u0631\u0647 \u062a\u0644\u0627\u0634 \u06a9\u0646\u06cc\u062f.")
            return
        trades = data.get("trades", [])
        if not trades:
            await message.answer("\U0001f4ed \u062a\u0627\u0631\u06cc\u062e\u0686\u0647\u200c\u0627\u06cc \u06cc\u0627\u0641\u062a \u0646\u0634\u062f.")
            return
        await message.answer(format_trade_list(trades), parse_mode="HTML")
    ...
    async def confirm_close_trade(callback: types.CallbackQuery) -> None:
        ...
        if not token:
            await callback.answer("\u26d4\ufe0f \u0646\u06cc\u0627\u0632 \u0628\u0647 \u0627\u062d\u0631\u0627\u0632 \u0647\u0648\u06cc\u062a.", show_alert=True)
            return
        result = await _api_post(f"/trades/{trade_id}/close", token, {})
        if result is None:
            await callback.message.answer("\u274c \u0628\u0633\u062a\u0646 \u0645\u0639\u0627\u0645\u0644\u0647 \u0628\u0627 \u062e\u0637\u0627 \u0645\u0648\u0627\u062c\u0647 \u0634\u062f.")
        else:
            await callback.message.answer(
    ...
    async def cancel_close_trade(callback: types.CallbackQuery) -> None:
        await callback.message.answer("\u274e \u0628\u0633\u062a\u0646 \u0645\u0639\u0627\u0645\u0644\u0647 \u0644\u063a\u0648 \u0634\u062f.")
        await callback.answer()
