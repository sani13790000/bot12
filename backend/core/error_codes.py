...
_CODE_TO_HTTP: Dict[str, int] = {
    ...
    EC.AUTH_INVALID: 401,
    EC.AUTH_EXPIRED: 401,
    EC.AUTH_BLACKLISTED: 401,
    EC.AUTH_LOCKED: 429,
    EC.PERM_DENIED: 403,
    EC.PERM_ROLE_REQUIRED: 403,
    EC.PERM_OWNER_REQUIRED: 403,
    EC.VALIDATION_ERROR: 422,
    EC.VALIDATION_FIELD: 422,
    EC.VALIDATION_SYMBOL: 422,
    EC.VALIDATION_LOT: 422,
    EC.VALIDATION_PRICE: 422,
    EC.VALIDATION_PAGINATION: 422,
    EC.NOT_FOUND: 404,
    EC.CONFLICT: 409,
    EC.ALREADY_EXISTS: 409,
    EC.RATE_LIMITED: 429,
    EC.RATE_LIMITED_IP: 429,
    EC.RATE_LIMITED_USER: 429,
    EC.RISK_BLOCKED: 422,
    EC.RISK_GATE_FAIL: 422,
    EC.RISK_KILL_SWITCH: 503,
    EC.RISK_MARGIN: 422,
    EC.RISK_DRAWDOWN: 422,
    EC.RISK_DAILY_LIMIT: 422,
    EC.RISK_EXPOSURE: 422,
    EC.ORDER_DUPLICATE: 409,
    EC.ORDER_STATE: 409,
    EC.ORDER_SUBMIT_FAIL: 500,
    EC.ORDER_TIMEOUT: 504,
    EC.BROKER_CONNECTION: 503,
    EC.LICENSE_INVALID: 403,
    EC.LICENSE_EXPIRED: 403,
    EC.LICENSE_DEVICE_LIMIT: 403,
    EC.SUBSCRIPTION_REQUIRED: 402,
    EC.PAYMENT_FAILED: 402,
    EC.INTERNAL_ERROR: 500,
    EC.SERVICE_UNAVAILABLE: 503,
    EC.DATABASE_ERROR: 503,
    EC.TIMEOUT: 504,
    EC.SECURITY_INJECTION: 400,
    EC.SECURITY_PATH_TRAVERSAL: 400,
    EC.SECURITY_REPLAY: 400,
    EC.SECURITY_SIGNATURE: 400,
}
