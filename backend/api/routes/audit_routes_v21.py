...
try:
    ...
    async def get_audit_chain(
        ...
        try:
            ...
            return {"status": "ok", "records": records, "count": len(records), "offset": offset, "limit": limit}
    ...
    async def append_audit_event(
        ...
        try:
            ...
            log = get_audit_log()
            record = log.append(
                event=req.event, actor_id=req.actor_id,
                details=req.details, severity=req.severity,
            )
