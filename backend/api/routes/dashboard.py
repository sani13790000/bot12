...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
FastAPI router for the React dashboard.

Endpoints
---------
GET /dashboard/summary        — account + P&L snapshot
GET /dashboard/positions      — open positions list
GET /dashboard/performance    — key performance metrics
GET /dashboard/health         — system health overview
GET /dashboard/recent-signals — last N trade signals
"""
...
async def get_summary() -> Dict[str, Any]:
    ...
    - MT5 account info (balance, equity, margin)
    - Today’s P&L
    ...
    try:
        ...
        try:
            ...
            logger.warning("[dashboard] account info unavailable: %s", exc)
...
async def get_positions() -> Dict[str, Any]:
    """
    Return all open MT5 positions with their live P&L.
    """
    try:
        from backend.execution.mt5_connector import mt5_connector
...
async def get_performance(
    ...
    """
    Return aggregated performance metrics for the last *days* days.
    """
    try:
...
async def get_health() -> Dict[str, Any]:
    """
    Lightweight system health check for the dashboard header.

    Returns component status without requiring auth.
    """
    health: Dict[str, Any] = {}
    ...
    try:
        ...
        health["scheduler"] = {
            "running": scheduler._running,          # noqa: SLF001
            "tasks":   len(scheduler._tasks),       # noqa: SLF001
        }
    except Exception as exc:
        health["scheduler"] = f"unknown: {exc}"
...
async def get_recent_signals(
    ...
    """
    Return the last *limit* trade signals from the database.
    """
    try:
        from backend.database.client import db_client
