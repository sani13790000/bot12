-- Migration 019a: Phase 11-13 Core Tables (canonical)
-- Renamed from 20260619_019_phase11_13_tables.sql to resolve prefix conflict
-- BUG-N1 FIX: 019 prefix was duplicated — this is now 019a (canonical tables)
-- Supabase CLI executes 019a before 019b (alphabetical order)
BEGIN;
