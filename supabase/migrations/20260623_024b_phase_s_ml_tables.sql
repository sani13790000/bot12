-- supabase/migrations/20260623_024b_phase_s_ml_tables.sql
-- BUG-X3 fix: ml_models, decisions, session_events, db_health_log tables
-- Previously only existed in backend/database/migrations/migration_024.sql
-- which Supabase CLI never scans. Now in canonical migrations folder.
-- Non-overlapping with 20260623_024_phase_s_hardening.sql (indexes + refresh_tokens)
...
-- S-6f: walk_forward_results extra columns
